...
public class GetfitPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Getfit";
	...
	private GetfitPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(orm.Cliente.class);
		configuration.addAnnotatedClass(orm.Huella.class);
		configuration.addAnnotatedClass(orm.CapturaHuella.class);
		configuration.addAnnotatedClass(orm.Sede.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GetfitPersistentManager();
		}
