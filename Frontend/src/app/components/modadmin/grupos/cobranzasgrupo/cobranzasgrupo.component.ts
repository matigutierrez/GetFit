...
@Component({
    ...
    templateUrl: 'cobranzasgrupo.html',
    styleUrls: ['cobranzasgrupo.css']
})
export class CobranzasGrupoComponent implements OnDestroy {
    ...
    public onCreateCobranzaHistorica(cobranzaHistorica: CobranzaHistorica) {
        // Si se ha recibido la lista de cobranzas historicas
        if (this.cobranzasHistoricas) {
            // Si la cobranza historica pertenece al grupo
            if (cobranzaHistorica.contrato_historico.tgf_grupo_id == this.grupo.id) {
    ...
    public onCreateContratoHistorico(contratoHistorico: ContratoHistorico) {
        ...
        if (this.contratosHistoricos) {
            // Si el contrato historico pertenece al grupo
            if (contratoHistorico.tgf_grupo_id == this.grupo.id) {
    ...
    public set setGrupo(grupo: Grupo) {
        ...
        this._grupoService.getContratosCobranzas(grupo).subscribe(
            Response => {
                // Guardar contratos
        ...
        this._grupoService.getContratosCobranzasHistoricas(grupo).subscribe(
            Response => {
    ...
    public registrar(): void {
        ...
        this.registroCobranzaGrupoComponent.abrir(this.grupo);
    }
