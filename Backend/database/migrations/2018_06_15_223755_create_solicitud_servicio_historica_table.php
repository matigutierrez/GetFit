...
class CreateSolicitudServicioHistoricaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tgf_solicitud_servicio_historica', function (Blueprint $table) {
            ...
            $table->foreign('tgf_disponibilidad_historica_servicio_id', 'sse_dse_id')->references('id')->on('tgf_disponibilidad_historica_servicio')->onDelete('cascade')->onUpdate('cascade');
            ...
            $table->unique(['tgf_disponibilidad_historica_servicio_id', 'tgf_cliente_id'], 'sse_dse_id_u');
        });
    }
